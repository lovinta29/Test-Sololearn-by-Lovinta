...
WebUI.setText(findTestObject('Object Repository/Page_Sololearn Learn to Code/input_email'), 'lovita@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sololearn Learn to Code/input_password'), 'EZIzOShosS3c+gAeXlUmTCQlmNKowJbh')
