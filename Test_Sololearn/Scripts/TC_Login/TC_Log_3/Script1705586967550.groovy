...
WebUI.setText(findTestObject('Object Repository/Page_Sololearn Learn to Code/input_email'), 'lovinvita29@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sololearn Learn to Code/input_password'), 'YaRDnf2rE5z3ARXoKG+Ce1Xk2ufB4gJE')
